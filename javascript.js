...
const aboutDescriptions = [
    ...
    "I have been working in Unreal Engine 4 and 5 for a year, prior to that, I worked in Roblox Studio and Unity 3D, I have shipped 3 games in total, two of them in Unreal Engine. I am also familiar with Blender which I have been using for creating assets for my games (a year of experience). I have participated in an extracurricular project at the university, tackling the problem of multithreading. The project has its own <a href='https://repozytorium.ur.edu.pl/server/api/core/bitstreams/232412ba-3ffc-429f-a297-2e069d602701/content'>article</a> in an international technology magazine.",
