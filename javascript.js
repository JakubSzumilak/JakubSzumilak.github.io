...
const aboutDescriptions = [
    "I enlisted in a university course in Computer Science at State Higher School of Technology and Economics in Jarosław in October 2022. Since then I have achieved some successes, one of them being the annual GPA of 5.0 for the 2nd year. I took many courses in various IT fields, ranging from game development to creating websites. My certificates as well as my CV are presented in the <span class='docsRedir' onclick='goToDocs();'>'Documents'</span> section.",
